...
export class OdooRPCService {
    ...
    public createRecord(model: string, values: any) {
        let params = {
            model: model,
            vals: values,
            context: this.context
       	 };
        return this.sendRequest("/web/dataset/create", params);
	}

    public updateRecord(model: string, ids: any, values: any) {
        let params = {
            model: model,
	    ids: ids, 
            vals: values,
        ...
        return this.sendRequest("/web/dataset/write", params);
	}
